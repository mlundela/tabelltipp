...
public class BasicTest extends UnitTest {
  ...
  public void aVeryImportantThingToTest() {
    ...
    new TabellTips(henning, brann, 1).save();
    new TabellTips(henning, rosenborg, 2).save();
    new TabellTips(henning, viking, 3).save();

    new TabellTips(mads, rosenborg, 1).save();
    new TabellTips(mads, brann, 2).save();
    new TabellTips(mads, viking, 3).save();

    List<TabellTips> alleTips = TabellTips.findAll();
  ...
  public void heningTips() {
    ...
    assertEquals(32, TabellTips.all().fetch().size());
